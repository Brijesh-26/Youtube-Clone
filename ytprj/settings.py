...
SECRET_KEY = 'django-insecure-j$5sp_ss^*f3u*#(2umhx$*(dyali47%@%!zjv(!bg@yif1g3m'
...
DATABASES = {
    "default" : dj_database_url.parse("postgres://ytprojectdb_user:RFbDjpT4nbICkR3hJVO2RuKR6rJ1ZFOz@dpg-cki471212bvs739vuh70-a.singapore-postgres.render.com/ytprojectdb")
}
